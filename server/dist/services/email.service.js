...
exports.sendOtpEmail = exports.sendVerificationEmail = exports.sendResetPasswordEmail = exports.sendEmail = exports.transport = void 0;
...
If you did not request any password resets, then ignore this email.`;
  const html = getEmailWrapperHtml('Reset your password', `
...
If you did not create an account, then ignore this email.`;
  const html = getEmailWrapperHtml('Verify your email', `
...
This code is valid for 10 minutes. Do not share it with anyone.`;
  const html = getEmailWrapperHtml('Your Verification Code', `
      <h2>Mã xác thực tài khoản</h2>
      <p>Xin chào,</p>
      <p>Cảm ơn bạn đã lựa chọn trải nghiệm dịch vụ thế hệ mới của SmartStay AI.</p>
