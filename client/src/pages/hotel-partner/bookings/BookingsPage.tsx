...
/**
 * Bookings (`/partner/bookings`) — chủ KS xem & vận hành booking (check-in/out,
 * thu tiền mặt, no-show) cho MỘT khách sạn (quyền `getOperableHotel`). Khách sạn
 * đang chọn lưu trên query string (`?hotelId=...`).
 */
    ...
    return (
      <Shell>
        <EmptyState
          ...
          description="Complete hotel verification and get approved before managing bookings."
          action={
            <Button
