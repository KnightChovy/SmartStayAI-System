...
export default function AccountSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-be-vietnam text-2xl font-bold text-on-surface">Settings</h2>
        <p className="mt-1 text-sm text-on-surface-variant">Security and account preferences.</p>
      </div>
      ...
      >
        <h3 className="font-be-vietnam font-semibold text-on-surface">Change password</h3>
        ...
        <div className="flex items-center gap-3">
          ...
          {pwSaved && <span className="text-sm text-emerald-600">Password updated (demo).</span>}
        </div>
      </form>

      {/* Devices */}
      <div className="rounded-2xl border border-outline-variant/30 bg-surface p-5">
        <h3 className="font-be-vietnam font-semibold text-on-surface">Active sessions</h3>
      ...
      <div className="rounded-2xl border border-error/30 bg-error/5 p-5">
        <h3 className="font-be-vietnam font-semibold text-error">Delete account</h3>
