  ...
  const favorites = [
    {
      ...
      quote: "The attention to detail was beyond anything I've experienced. Truly a sanctuary.",
    ...
    },
    {
      ...
      quote: "Old world charm meets modern AI intelligence. Seamless booking and stay.",
