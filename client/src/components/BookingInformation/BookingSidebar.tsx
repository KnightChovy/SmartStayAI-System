    ...
    <aside className="space-y-6 lg:sticky lg:top-24 font-be-vietnam">
      ...
      <div className="bg-white dark:bg-card rounded-2xl border border-outline-variant/20 shadow-sm overflow-hidden">
        ...
        <div className="p-5">
          ...
          <h2 className="font-bold text-lg text-on-surface mb-1">Smart Stay AI</h2>
      ...
      <div className="bg-white dark:bg-card rounded-2xl border border-outline-variant/20 shadow-sm p-5">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <p className="text-[10px] text-outline font-bold uppercase tracking-wider mb-1">Check-in</p>
            <p className="text-sm font-bold text-on-surface">{formatDisplayDate(checkIn)}</p>
          </div>
          <div>
            <p className="text-[10px] text-outline font-bold uppercase tracking-wider mb-1">Check-out</p>
            <p className="text-sm font-bold text-on-surface">{formatDisplayDate(checkOut)}</p>
          </div>
        </div>
        <div className="space-y-2 border-t border-outline-variant/5 pt-3">
          ...
          <div className="bg-surface-container-low p-3.5 rounded-xl mt-4 border border-outline-variant/10">
            <p className="text-[9px] text-outline font-bold uppercase tracking-wider mb-1">Room Type</p>
            <p className="text-xs font-bold text-on-surface leading-tight">{roomName}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-card rounded-2xl border border-outline-variant/25 shadow-md p-5 relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-bold text-on-surface uppercase tracking-wider">Total Price</span>
          <div className="text-right">
            <p className="text-on-surface-variant line-through text-xs font-medium mb-0.5">${originalTotal}</p>
