...
export function ImageGallery({
  ...
  return (
    <section className="mb-10">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-[350px] md:h-[500px] relative overflow-hidden">
        {/* Large Primary Image */}
        <div
                ...
                {images.map((_, idx) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-all cursor-pointer border-none ${
                      activePhotoIdx === idx ? 'bg-white scale-125' : 'bg-white/30 hover:bg-white/60'
                    }`}
                  />
                ))}
              </div>
