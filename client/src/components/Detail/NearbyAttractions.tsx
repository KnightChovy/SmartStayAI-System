        ...
        <div className="space-y-5">
          {[
            { icon: 'park', title: 'City Park', detail: '350m • 4 min walk' },
            {
              icon: 'theater_comedy',
              title: 'Opera House',
              detail: '1.2km • 15 min walk',
            },
            {
              icon: 'restaurant',
              title: "L'Artiste French Bistro",
              detail: '150m • 2 min walk',
            },
          ].map((place, idx) => (
          ...
          {[
            {
              ...
              detail: '500m • 6 min walk',
            },
            {
              icon: 'museum',
              title: 'Modern Art Gallery',
              detail: '800m • 10 min walk',
            },
            {
              icon: 'shopping_bag',
              title: 'The Avenue Luxury Mall',
              detail: '1.5km • 5 min drive',
            },
          ].map((place, idx) => (
            <div key={idx} className="flex items-start gap-3">
              <span className="material-symbols-outlined text-primary text-xl mt-0.5">
