    ...
    <div className="space-y-8">
      ...
      <section className="bg-red-500/5 p-5 rounded-3xl border border-red-500/10 flex gap-4 items-start">
        ...
        <div className="space-y-1 text-xs leading-relaxed font-semibold text-on-surface-variant">
          <p>
            Please note that all rooms are strictly non-smoking. Parties or
            large events are not permitted within the suites to ensure a restful
            environment for all guests. Pets are not permitted on the premises.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-card p-6 md:p-8 rounded-3xl border border-outline-variant/20 shadow-sm">
        ...
        <div className="space-y-3">
          {[
            ...
            <details
              key={i}
              className="group bg-surface-container-low/30 border border-outline-variant/10 rounded-2xl overflow-hidden transition-all duration-300"
            >
