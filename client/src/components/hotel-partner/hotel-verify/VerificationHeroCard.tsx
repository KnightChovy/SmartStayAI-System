    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col justify-between relative overflow-hidden h-full">
      ...
      <div className="relative z-10">
        ...
        <p className="text-slate-600 text-sm leading-relaxed max-w-xl mb-6">
          Complete verification to start receiving bookings on SmartStay AI. A verified badge builds trust and unlocks full platform capabilities.
        </p>
      </div>
      ...
      <div className="bg-slate-50/70 rounded-xl p-5 mb-6 border border-slate-100 relative z-10">
        ...
        {/* Progress bar */}
        <Progress value={0} className="h-2.5 mb-3 bg-role-staff-light **:data-[slot=progress-indicator]:bg-role-partner-primary" />
      ...
      <div className="relative z-10">
        <Button onClick={onStart} size="lg" className="bg-role-partner-primary hover:bg-role-partner-secondary cursor-pointer text-white rounded-lg px-6 h-10 text-sm font-medium transition-all shadow-sm">
